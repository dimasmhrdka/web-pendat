...
st.title('Klasifikasi Kredit Score Menggunakan Algoritma RandomForest')
st.write("Dataset Yang digunakan adalah **Kredit Score** dari [Github saya](https://raw.githubusercontent.com/dimasmhrdka/data-csv/main/credit_score.csv)")
st.sidebar.header("Parameter Inputan")

kprYa = st.sidebar.text_input('KPR Aktif (0 OR 1)')
kprTidak = st.sidebar.text_input('KPR Tidak Aktif (0 OR 1)')
overdue31 = st.sidebar.text_input('Rata-rata Overdue 0 - 31 Hari (0 OR 1)')
overdue45 = st.sidebar.text_input('Rata-rata Overdue 31 - 45 Hari (0 OR 1)')
overdue60 = st.sidebar.text_input('Rata-rata Overdue 46 - 60 Hari (0 OR 1)')
overdue90 = st.sidebar.text_input('Rata-rata Overdue 61 - 90 Hari (0 OR 1)')
overdueUpto90 = st.sidebar.text_input('Rata-rata Overdue > 90 Hari (0 OR 1)')
pendapatan = st.sidebar.text_input('Pendapatan Setahun Juta (0 - 1)')
durasiPinjaman = st.sidebar.text_input('Durasi Pinjaman Bulan (0 - 1)')
jumlahTanggungan = st.sidebar.text_input('Jumlah Tanggungan (0 - 1)')
data = {
    "KPR Aktif" : kprYa,
